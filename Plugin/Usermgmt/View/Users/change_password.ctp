<section id="profile">
    ...
    <div class="form-group">
      <?php echo $this->Form->input("cpassword" ,array("type"=>"password",'label' => 'New Password again','div' => false,'class'=>"form-control inp_edit",'error' => array('attributes' => array('wrap' => 'div','class' => 'error_message')) ))?>
    </div>
      ...
      <div class="flip_items">
        <div class="box front"><button class="bricks_btn edit_btn" type="submit" onclick="window.location.href='<?php echo $this->webroot;?>passes'">SAVE</button></div>
      </div>
    </div>
