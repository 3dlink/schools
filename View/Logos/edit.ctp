...
<?php echo $this->Form->create('Logo'); echo $this->Form->input('id');?>
    <fieldset>
      ...
      <div class="margenesHorizontales">
	        ...
	        <div class="form-group">
	          ...
	          <?php echo $this->Form->input('name',array('div'=>false,'label'=>false,'class'=>'form-control','placeholder'=>'Name')); ?>
				...
				<div class="col-md-6">
	        <div class="form-group">
	          <label style="color:black;">Current Logo</label>
	          <img style="width:50%;" src="<?php echo $this->webroot; ?>files/<?php echo $this->data['Logo']['logo']; ?>">
	        </div>
	      </div>

	      <legend>Change LOGO File</legend>
